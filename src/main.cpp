...
$on_mod(Loaded) {
    ...
    // Add "Interface" tab to edit theme settings
    {
        ...
        tab->addInputFloat("interface.font-size", "fontSize", 1.f, 999999999.f)
           ->callback([](float value) {
        ...
        blurToggle->addOptions([](auto opt) {
            opt->addInputFloat("interface.blur-speed", "blurSpeed", 0.f, 999999999.f, "%.3f s")
        ...
        animateToggle->addOptions([](auto opt) {
                opt->addInputFloat("menu.animationDuration", 0.f, 999999999.f, "%.3f s");
