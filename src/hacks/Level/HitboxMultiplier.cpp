        ...
        void init() override {
            ...
            tab->addToggle("level.hitbox_multiplier")->handleKeybinds()->setDescription()
               ...
               ->addOptions([](std::shared_ptr<gui::MenuTab> options) {
                   options->addInputFloat("level.hitbox_multiplier.player", 0.f, FLT_MAX, "%.2fx");
                   options->addInputFloat("level.hitbox_multiplier.solid", 0.f, FLT_MAX, "%.2fx");
                   options->addInputFloat("level.hitbox_multiplier.hazard", 0.f, FLT_MAX, "%.2fx");
               });
        }
